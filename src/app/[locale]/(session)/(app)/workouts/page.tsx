...
import type { WorkoutDefinition, Page } from '@/lib/types'
...
export default function WorkoutsPage() {
  ...
  const { data: workoutsPage, mutate } = useSWR<Page<WorkoutDefinition>>('/api/workouts', fetcher)
  const workouts = workoutsPage?.items

  function handleCreated(id: string) {
    router.push(`/${locale}/workouts/${id}`)
  }
